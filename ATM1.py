...
class ATM1():
    ...
    def __init__(self, top):
        ...
        button1 = Button(self.mOffsets,font=('bold italic',20),text="English",bg="yellow",fg="blue",height=1,width=20,command=CALL3)
...
class ATM3():
    ...
    def __init__(self, top):
            ...
            button5 = Button(self.mOffsets,font=('bold italic',20),text="USERID AND PASS..",bg="yellow",fg="blue",height=1,width=20,command=CALL21)
...
class ATM5():
    ...
    def __init__(self, top):
            ...
            entry1=Entry(self.mOffsets,font=('arial',24,'bold'),textvar=Password10,bd=5,insertwidth=8,bg="yellow",justify='left')
...
class ATM12():
    ...
    def __init__(self, top):
            ...
            lblInfo=Label(self.mOffsets,font=('bold italic ',35),text="REGISTRATION FORM",fg="white",bg="blue",bd=10,anchor='w')
            lblInfo.place(x=400,y=120)

            lblInfo1=Label(self.mOffsets,font=('arial',30),text="Account No. :",fg="white",bg="blue",bd=10,anchor='w')
            lblInfo1.place(x=50,y=208)

            lblInfo2=Label(self.mOffsets,font=('arial',30),text="First Name   :",fg="white",bg="blue",bd=10,anchor='w')
            lblInfo2.place(x=50,y=295)

            lblInfo3=Label(self.mOffsets,font=('arial',30),text="Password    :",fg="white",bg="blue",bd=10,anchor='w')
            lblInfo3.place(x=50,y=382)

            lblInfo4=Label(self.mOffsets,font=('arial',30),text="Amount       :",fg="white",bg="blue",bd=10,anchor='w')
            lblInfo4.place(x=50,y=464)

            lblInfo4=Label(self.mOffsets,font=('arial',30),text="User Id       :",fg="white",bg="blue",bd=10,anchor='w')
            lblInfo4.place(x=50,y=546)

            lblInfo4=Label(self.mOffsets,font=('arial',30),text="Int.. Password       :",fg="white",bg="blue",bd=10,anchor='w')
            lblInfo4.place(x=40,y=628)
            ...
            entry2.place(x=420,y=305)

            entry3=Entry(self.mOffsets,font=('arial',24,'bold'),textvar=Password1,bd=10,insertwidth=8,bg="yellow",justify='left')
            entry3.place(x=420,y=390)

            entry4=Entry(self.mOffsets,font=('arial',24,'bold'),textvar=Amount1,bd=10,insertwidth=8,bg="yellow",justify='left')
            entry4.place(x=420,y=475)

            entry5=Entry(self.mOffsets,font=('arial',24,'bold'),textvar=Userid1,bd=10,insertwidth=8,bg="yellow",justify='left')
            entry5.place(x=420,y=560)

            entry6=Entry(self.mOffsets,font=('arial',24,'bold'),textvar=Password3,bd=10,insertwidth=8,bg="yellow",justify='left')
            entry6.place(x=420,y=645)
...
class ATM21():
    ...
    def __init__(self, top):
            ...
            lblInfo1=Label(self.mOffsets,font=('arial',30),text="User Id :",fg="white",bg="blue",bd=10,anchor='w')
            lblInfo1.place(x=50,y=308)

            lblInfo1=Label(self.mOffsets,font=('arial',30),text="Password :",fg="white",bg="blue",bd=10,anchor='w')
            lblInfo1.place(x=50,y=408)
            
            lblInfo2=Label(self.mOffsets,font=('arial',30),text="Withdrawal Amount :",fg="white",bg="blue",bd=10,anchor='w')
            lblInfo2.place(x=50,y=508)

            #========================= BUTTON ===================================================================

            entry1=Entry(self.mOffsets,font=('arial',24,'bold'),textvar=Userid40,bd=10,insertwidth=8,bg="yellow",justify='left')
            entry1.place(x=430,y=320)

            entry2=Entry(self.mOffsets,font=('arial',24,'bold'),textvar=Password41,bd=10,insertwidth=8,bg="yellow",justify='left')
            entry2.place(x=430,y=420)

            entry2=Entry(self.mOffsets,font=('arial',24,'bold'),textvar=Amount42,bd=10,insertwidth=8,bg="yellow",justify='left')
            entry2.place(x=430,y=520)

            button1 = Button(self.mOffsets,font=('bold italic',20),text="Withdraw",bg="yellow",fg="blue",height=1,width=20,command=Update7)
            button1.place(x=1005,y=400)
...
class ATM22():
    ...
    def __init__(self, top):
            ...
            lblInfo=Label(self.mOffsets,font=('bold italic ',35),text="UPDATION FOR INTERNET BANKING ",fg="white",bg="blue",bd=10,anchor='w')
            lblInfo.place(x=230,y=150)

            lblInfo1=Label(self.mOffsets,font=('arial',30),text="Account No. :",fg="white",bg="blue",bd=10,anchor='w')
            lblInfo1.place(x=50,y=308)

            lblInfo1=Label(self.mOffsets,font=('arial',30),text="New User Id :",fg="white",bg="blue",bd=10,anchor='w')
            lblInfo1.place(x=50,y=408)

            lblInfo1=Label(self.mOffsets,font=('arial',30),text="New Password :",fg="white",bg="blue",bd=10,anchor='w')
            lblInfo1.place(x=50,y=508)

            #========================= BUTTON ===================================================================

            entry1=Entry(self.mOffsets,font=('arial',24,'bold'),textvar=Account47,bd=10,insertwidth=8,bg="yellow",justify='left')
            entry1.place(x=430,y=320)

            entry1=Entry(self.mOffsets,font=('arial',24,'bold'),textvar=Userid48,bd=10,insertwidth=8,bg="yellow",justify='left')
            entry1.place(x=430,y=420)

            entry2=Entry(self.mOffsets,font=('arial',24,'bold'),textvar=Password49,bd=10,insertwidth=8,bg="yellow",justify='left')
            entry2.place(x=430,y=520)

            button1 = Button(self.mOffsets,font=('bold italic',20),text="Submit",bg="yellow",fg="blue",height=1,width=20,command=Update8)
            button1.place(x=1005,y=400)
...
cursor=db.cursor()
cursor.execute("CREATE TABLE IF NOT EXISTS ATMDATA(AccountNumber TEXT,FirstName TEXT,Password TEXT,Amount TEXT,Userid TEXT,Password1 TEXT)")
db.commit()
...
def Insert():
  ...
  with ins:
          cursor=ins.cursor()
          cursor.execute('INSERT INTO ATMDATA(AccountNumber,FirstName,Password,Amount,Userid,Password1) VALUES(?,?,?,?,?,?)',( Account2,Firstname2,Password2,Amount2,Userid2,Password4))
          db.close()

#========================================insert data in table2 ==========================================================
Account47=StringVar()
Userid48=StringVar()
Password49=StringVar()

def Update8():

  Account50=Account47.get()
  Userid51=Userid48.get()
  Password52=Password49.get()
  
  up=sqlite3.connect('ATM.db')
  cursor=up.cursor()
  cursor.execute("UPDATE ATMDATA SET Userid = ? ,Password1 = ? WHERE AccountNumber = ?",(Userid51,Password52,Account50))
  up.commit()
...
def Update():
    ...
    up=sqlite3.connect('ATM.db')
    cursor=up.cursor()
    cursor.execute("SELECT * FROM ATMDATA WHERE AccountNumber = ?",(Account4,))
    row=cursor.fetchone()
    ...
    if Account4 == row[0]:
        ...
        up.commit()
    '''else:
        tkinter.messagebox.showinfo('window Title','Your Account Number Is Incorrect')
        answer = tkinter.messagebox.askquestion('Question 1','Yes for Quit and NO for Continue')
...
Userid40=StringVar()
Password41=StringVar()
Amount42=StringVar()

def Update7():

    Userid43=Userid40.get()
    Password44=Password41.get()
    Amount45=Amount42.get()

    up1=sqlite3.connect('ATM.db')
    cursor=up1.cursor()
    cursor.execute("SELECT * FROM ATMDATA WHERE Userid = ?",(Userid43,))
    row=cursor.fetchone()
    Amount12=int(row[3])-int(Amount45)
    up=sqlite3.connect('ATM.db')
    cursor=up.cursor()
    cursor.execute("UPDATE ATMDATA SET Amount = ? WHERE Userid = ?",(int(Amount12),Userid43))
    up.commit()
#================================================Transfer money ==================================================================
...
canvas = Canvas(width = 310, height = 120, bg = 'yellow')
canvas.place(x=0,y=0)
gif1 = PhotoImage(file = 'sbi1.png')
canvas.create_image(156.5, 60, image = gif1)
...
button4 = Button(root,font=('bold italic',20),text="UPDATE USERID & Pass..",bg="blue",fg="white",height=1,width=20,command = CALL22)
button4.place(x=30,y=600)
